...
object Dependencies {
  ...
  val inventoryDependencies: Seq[ModuleID] = Seq(h2, logback, scalaTest, mock, slick, slickHikariCP, jdbcConnector, akkaHttp, akkaStream, sparayJson, akkaTestKit, slickTest3, slickTest4)
